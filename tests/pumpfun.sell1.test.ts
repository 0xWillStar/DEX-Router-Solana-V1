...
describe("pumpfun.sell test", () => {
  ...
  // https://solscan.io/tx/3bgU1zkGrcW5zMyDiiEacDbudjzwqSxNbbySGAiLwy5ybrkoi3dpUQRYTXtKWgpyiEBKQgrsagd82Q37U1F38UbD
...
// [[test.validator.clone]]
// address = "9quq34qD8MUTKiRB1WRn1fGPe5kPrbbwEm1v2BdupDXk" # bonding_curve
// [[test.validator.clone]]
// address = "H4zcpZ8jWrfW8K71CccEBFK7xf19VMdwZ8pTB3aHzwsU" # associated_bonding_curve
// [[test.validator.clone]]
...
// address = "pfeeUxB6jkeY1Hxd7CsFCAjcbHA9rWtchMGdZ6VojVZ" # fee_program
  it("sell2-no cashback", async () => {
    const FEE_ACCOUNT = new PublicKey("GJHUsZwxMj6CaMznx5x23GX3Ka7d334H3473RdmjSAv5");

    // Account addresses
    const WSOL_MINT = new PublicKey("So11111111111111111111111111111111111111112");
    const BASE_MINT = new PublicKey("3oe4Wk6JKvT5HGPoQQrpjP3SyRNswEKMT8vj9U8Hpump");
    ...
    const pumpfunSell2AccountsConfig = [
      ...
      { pubkey: new PublicKey("3oe4Wk6JKvT5HGPoQQrpjP3SyRNswEKMT8vj9U8Hpump"), isSigner: false, isWritable: false }, // mint
      { pubkey: new PublicKey("9quq34qD8MUTKiRB1WRn1fGPe5kPrbbwEm1v2BdupDXk"), isSigner: false, isWritable: true }, // bonding_curve
      { pubkey: new PublicKey("H4zcpZ8jWrfW8K71CccEBFK7xf19VMdwZ8pTB3aHzwsU"), isSigner: false, isWritable: true }, // associated_bonding_curve
      { pubkey: new PublicKey("11111111111111111111111111111111"), isSigner: false, isWritable: false }, // system_program
      { pubkey: new PublicKey("5CNagSp78VmngKT8kded94BSLuqfaHuxREbamR7fSFkP"), isSigner: false, isWritable: true }, // creator_vault
      ...
      { pubkey: new PublicKey("GjyDcvqqQKAq9LrjSncqw12kJ744VTYG3Mz3XpLPc2WN"), isSigner: false, isWritable: false }, // pool_v2
    ];
